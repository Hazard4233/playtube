...
{
    public class ReplyResponseCommentBottomSheet : BottomSheetDialogFragment
    {
        ...
        private MediaPlayerActivity ActivityContext;
        private string Type;
        private RecyclerViewOnScrollListener MainScrollEvent;
        private ResponseCommentClickListener CommentClickListener;
        private static ReplyResponseCommentBottomSheet Instance;
        #endregion
        ...
        public override void SetupDialog(Dialog dialog, int style)
        {
            try
            {
                ...
                if (Type == "video") ActivityContext = MediaPlayerActivity.GetInstance();
        ...
        public static ReplyResponseCommentBottomSheet GetInstance()
        {
            try
            {
                return Instance;
