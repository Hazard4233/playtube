...
{
    public class ResponseReplyAdapter : RecyclerView.Adapter
    {
        ...
        public ResponseReplyAdapter(Activity context)
        {
            try
            {
        ...
        private async void OnLikeButtonClick(ReplyAdapterViewHolder holder, ReplyAdapterClickEventArgs e)
        {
            try
            {
                        ...
                        if (e.Class != null)
                        {
                            ...
                            using (var client = new System.Net.Http.HttpClient())
                            {
                                var formContent = new System.Net.Http.FormUrlEncodedContent(new[]
                                {
                                    ...
                                    new KeyValuePair<string, string>("reply_id", e.Class.Id.ToString()),
        ...
        private async void OnUnLikeButtonClick(ReplyAdapterViewHolder holder, ReplyAdapterClickEventArgs e)
        {
            try
            {
                if (Methods.CheckConnectivity())
