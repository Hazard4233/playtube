...
{
    public class AdminResponseCommentsFragment : Fragment
    {
        #region Variables Basic

        private SwipeRefreshLayout SwipeRefreshLayout;
        private LatestResponsePlayerActivity MainContext;
        ...
        private AdminResponseCommentClickListener CommentClickListener;
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                HasOptionsMenu = true;
                MainContext = LatestResponsePlayerActivity.GetInstance();
                CommentClickListener = new AdminResponseCommentClickListener(Activity, "Comment");
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
        ...
        public override async void OnDestroy()
        {
            ...
            {
                base.OnDestroy();
                //await TabbedMainActivity.GetInstance().VideoDataWithEventsLoader.ResponseFragment.GetResponseList(TabbedMainActivity.GetInstance().VideoData.VideoId);
                //TabbedMainActivity.GetInstance().VideoDataWithEventsLoader.ResponseFragment.GetUserResponse(TabbedMainActivity.GetInstance().VideoData.VideoId);
