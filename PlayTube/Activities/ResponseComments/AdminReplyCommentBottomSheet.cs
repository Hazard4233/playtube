...
{
    public class AdminReplyCommentBottomSheet : BottomSheetDialogFragment
    {
        ...
        private LatestResponsePlayerActivity ActivityContext;
        private string Type;
        private RecyclerViewOnScrollListener MainScrollEvent;
        private ResponseCommentClickListener CommentClickListener;
        private static AdminReplyCommentBottomSheet Instance;
        #endregion
        ...
        public override void SetupDialog(Dialog dialog, int style)
        {
            try
            {
                ...
                if (Type == "video") ActivityContext = LatestResponsePlayerActivity.GetInstance();
        ...
        public static AdminReplyCommentBottomSheet GetInstance()
        {
            try
            {
                return Instance;
