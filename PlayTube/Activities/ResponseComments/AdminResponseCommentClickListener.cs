...
{
    public class AdminResponseCommentClickListener : Java.Lang.Object, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback, MaterialDialog.IInputCallback
    {
        private readonly Activity Context;
        private readonly LatestResponsePlayerActivity MainContext;
        private CommentObject CommentObject;
        private ReplyObject ReplyObject;
        private string TypeDialog;
        private readonly string TypeClass;

        public AdminResponseCommentClickListener(Activity context, string typeClass)
        {
            Context = context;
