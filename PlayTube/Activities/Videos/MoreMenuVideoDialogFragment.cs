...
namespace PlayTube.Activities.Videos
{
    public class MoreMenuVideoDialogFragment : BottomSheetDialogFragment, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private RelativeLayout ReportCopyRightLayout, ReportLayout, QualityLayout, HelpFeedbackLayout, MakeOfflineLayout;
        private TextView ReportCopyRightIcon, ReportCopyRightText, ReportIcon, ReportText, QualityIcon, QualityText, HelpFeedbackIcon, HelpFeedbackText, MakeOfflineIcon, MakeOfflineText;
