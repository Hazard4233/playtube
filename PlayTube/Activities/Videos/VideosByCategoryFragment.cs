...
{
    public class VideosByCategoryFragment : Fragment, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
                ...
                else
                {
                    ...
                    if (respondList > 0)
                    {
                        ...
                        if (countList > 0)
                        {
                            ...
                            Activity.RunOnUiThread(() => { MAdapter.NotifyItemRangeInserted(countList - 1, MAdapter.VideoList.Count - countList); });
                        }
                        else
                        {
