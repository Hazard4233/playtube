...
namespace PlayTube.Activities.Videos
{
    public class NextToFragment : Fragment
    {
        ...
        private RelativeLayout relativeNextTo;
        #endregion
        ...
        private void InitComponent(View view)
        {
            try
            {
                ...
                relativeNextTo = (RelativeLayout)view.FindViewById(Resource.Id.relativeNextTo);
                relativeNextTo.Visibility = ViewStates.Visible;
                EmptyStateLayout = view.FindViewById<ViewStub>(Resource.Id.viewStub);
                AutoNextswitch = view.FindViewById<Switch>(Resource.Id.AutoNextswitch);
