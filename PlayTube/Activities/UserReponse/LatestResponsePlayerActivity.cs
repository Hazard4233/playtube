...
{
    [Activity(Label = "LatestResponsePlayerActivity", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class LatestResponsePlayerActivity : AppCompatActivity
    {
        private static LatestResponsePlayerActivity Instance;
        ...
        public ResponseComments.AdminResponseCommentsFragment CommentsFragment;
        ...
        public static LatestResponsePlayerActivity GetInstance()
        {
            try
            {
                return Instance;
    ...
    internal class LatestPlayerListener : Java.Lang.Object, IPlayerEventListener, PlayerControlView.IVisibilityListener
    {
        private LatestResponsePlayerActivity mediaPlayerActivity;
        private readonly ProgressBar LoadingProgressBar;
        public LatestPlayerListener(LatestResponsePlayerActivity mediaPlayerActivity)
        {
